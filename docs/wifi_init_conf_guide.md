...
> **[정정 2026-09-14] FW는 정적 pair를 `40/65`로 덮어쓴다 — 트리거는 트래픽이다**: 아래 2026-08-31
> 노트의 "30/50 복귀 미재현"은 그 값·그 자극에 대해서는 여전히 사실이지만, 정적 pair가 유지된다는
...
> - **도착값은 `40/65`로 불변**이다. 출발값 5종(`70/90`x14, `58/90`, `60/80`, `65/90`, `80/90`)에서
>   관측된 전환 18회 전부.
