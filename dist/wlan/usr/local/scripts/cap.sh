...
tshark -r capture.pcap -T fields \
  -e wlan.sa -e wlan.da -e wlan.fc.type -e wlan.fc.subtype \
  -e wlan.fc.retry -e wlan.seq -e radiotap.dbm_antsignal -e radiotap.dbm_antnoise \
  -E separator=, | \
awk -v mac_mlan="$mac_mlan" -v mac_bc="$mac_bc" -F, 'BEGIN {
