...
#sleep 2
echo /dev/null > /var/log/cantops/scan/mlan0/beacon.json
echo /dev/null > /var/log/cantops/scan/mlan1/beacon.json
echo /dev/null > /var/log/cantops/link/mlan0/link.json
echo /dev/null > /var/log/cantops/link/mlan1/link.json
