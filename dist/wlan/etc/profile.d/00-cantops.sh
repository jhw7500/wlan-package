...
alias blog0='cat $JSONDIR0/beacon.json'
alias blogg0='cat $JSONDIR0/beacon.json | grep -i $1 -a'
alias blogt0='cat $JSONDIR0/beacon.json | tail -n $1'
alias blogh0='cat $JSONDIR0/beacon.json | head -n $1'
alias blogf0='tail -f $JSONDIR0/beacon.json'
