...
alias nlog='cat $STATDIR0/snap.log'
alias nlogg='cat $STATDIR0/snap.log | grep -i $1 -a'
alias nlogt='cat $STATDIR0/snap.log | tail -n $1'
alias nlogh='cat $STATDIR0/snap.log | head -n $1'
alias nlogf='tail -f $STATDIR0/snap.log'
...
alias nlog1='cat $STATDIR1/snap.log'
alias nlogg1='cat $STATDIR1/snap.log | grep -i $1 -a'
alias nlogt1='cat $STATDIR1/snap.log | tail -n $1'
alias nlogh1='cat $STATDIR1/snap.log | head -n $1'
alias nlogf1='tail -f $STATDIR1/snap.log'
